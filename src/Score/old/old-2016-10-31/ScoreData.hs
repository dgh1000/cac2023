...
data MarkWord = MwMark Mark
              | MwWarpTemp Int Int (Maybe BeatsValue) BeatsValue Bool
                ...
                --   <amount of warp>
                --   <true if global warp>
              | MwAbsWarpTemp WarpSide BeatsValue
                -- ^ <warp side (left or right)>
                --   <warp amount specified as final absolute duration of
                --    interval>
              | MwSetTempo BeatsValue
              | MwSetVar String BeatsValue
              | MwPause (Either Double BeatsValue)
...
data Mark = SymbolMark         String Int
          | InstrTechnique     (Either String [String])
            -- either technique name or list of midi channels as named in the
            -- config file
          | SetTempo           Double
...
data BeatsValue = BeatsValue Double (Maybe String)
                deriving(Show)
