...
instr 1
  ...
  ahammer     noise 20000, 0

  ; compute hammer envelope
  aenv        linseg 0, 1/icps, 1, 1/icps, 1, 1/icps, 0

  ; waveguide
  a0point5    init 0.5
  asig        modern_waveguide aenv*ahammer/10, icps, 6.0, a0point5
  ; asig        streson aenv*ahammer/4, icps, 0.99999
  asig        dcblock asig

  ; asig        oscili 5000, icps

  ; envelope
  kamplEnv    linsegr 0, 0.001, 1, 0.1, 0

              zawm asig*kamplEnv, 1
              zawm asig*kamplEnv, 2
endin
...
instr 1000
  ...
  aclipL       clip iwet*arvbL + (1-iwet)*asigL, 0, 12000
  aclipR       clip iwet*arvbR + (1-iwet)*asigR, 0, 12000
