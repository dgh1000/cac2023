...
ioverlap = 450  ; about every 10 ms
; iwinsize will equal ifftsize
iwinsize = 2048
; size of the allocated tables for storing pvsanal output
itablesize = 8192
; input sound file
Sinput = "/giga/vienna/18-Clarinet-Bb/KLB_PERF-LEGATO-waves/KLB_pA_sus_mp_C4.wav"
...
ktim  timeinstk
     ...
     ;  ================================================================
     SfileNameA   sprintfk "c:/Temp/csound/tables/clarinet-C4/a%06d.txt", ktim
     SfileNameF   sprintfk "c:/Temp/csound/tables/clarinet-C4/f%06d.txt", ktim
